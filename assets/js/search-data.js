    ...
    handler: () => {
      window.location.href = "/~nqduc/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-received-research-funding-from-microsoft-accelerate-foundation-models-research-afmr-program",
          title: '🎯 Received research funding from Microsoft Accelerate Foundation Models Research (AFMR) program.',
          description: "",
