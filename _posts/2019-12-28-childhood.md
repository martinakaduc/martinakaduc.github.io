...
<div class="row mt-3">
    <div class="col-sm mx-auto">
        {% include figure.liquid loading="eager" path="assets/img/posts/childhood.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

When I was young, I used to put my hand in my shirt and tell others I had an arm amputation.\
I press the exit button every time I'm about to lose in a video game.\
